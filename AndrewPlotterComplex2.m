...
legend('Simulation 1','Simulation 2','Simulation 3','Model','location','southwest')
% plot(tEE,M(:,1)-.025,'k')
subplot(2,1,2)
...
saveas(gcf,'Lab3_SegwayComplicated2_Lidar.pdf')